...
* [OpenRefine](https://openrefine.org/){.external target="_blank"} 
  ...
  * [Post45DC OpenRefine Reconciliation Service](https://data.post45.org/our-tools.html){.external target="_blank"} 
...
> **Example**: *this is what split columns may look like if you use comma or semicolon-separated internal delimiters. Note how the comma-separated option unintentionally splits the names by first name / last name and not just by individual*
...
Including the ISBN or ISSN for a publication can make specific bibliographic information more accessible. Tools like our [OpenRefine script](https://data.post45.org/our-tools.html){.external target="_blank"} or citation managers like [Zotero](https://www.zotero.org/){.external target="_blank"} can easily automate searches for this information. 
