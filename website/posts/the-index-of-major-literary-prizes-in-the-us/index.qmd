...
generateTabulatorTableFromCSV(
  ...
  "https://raw.githubusercontent.com/Post45-Data-Collective/website/refs/heads/main/datasets/major_literary_prizes/major_literary_prizes-winners_judges.csv",
  {
    ...
    columnPopups: [
      ...
      "Provisionally labeled by the research team based on pronouns used in biographical notes",
      "Name of MFA program institution if individual attended an MFA program",
      "Either 'winner' or 'judge'",
      "Year the prize was awarded",
      "Name of the prize",
      "Prize amount in 2022 dollars",
      "Nonprofit organization that oversees the prize",
      "'career' (overall career) or 'book' (specific book)",
      "'poetry,' 'prose,' or 'no genre' (e.g., MacArthur)",
      "One of 12 listed elite institutions (Barnard, Brown, Columbia, Cornell, Dartmouth, Harvard, Princeton, Radcliffe, Stanford, UChicago, UPenn, Yale)",
      "'graduate' if individual attended a graduate program (masters, PhD, JD, or medical)",
      "'Stegner' if individual received a Wallace Stegner Fellowship at Stanford",
      "Title of the awarded book if prize_type is 'book'",
      "Author's Wikidata Q number",
      "Author's VIAF cluster number",
      "Author's LCCN from id.loc.gov"
    ],
    columnWidths: { "gender": 140, "role": 110, "prize_year": 100, "prize_type": 110,
                    "prize_genre": 120, "stegner": 110, "graduate_degree": 130,
                    "prize_name": 220, "prize_institution": 240, "elite_institution": 220,
                    "mfa_degree": 220 },
    currencyColumns: ["prize_amount"],
    rangeSliderColumns: ["prize_year", "prize_amount"],
    categoryColumns: ["gender", "role", "prize_type", "prize_genre", "graduate_degree", "stegner",
                      "prize_name", "prize_institution", "elite_institution", "mfa_degree"],
...
generateTabulatorTableFromCSV(
  ...
  "https://raw.githubusercontent.com/Post45-Data-Collective/website/refs/heads/main/datasets/major_literary_prizes/major_literary_prizes-hathitrust_metadata.csv",
  {
    ...
    columnWidths: { "gender": 110, "hathi_rights": 130 },
