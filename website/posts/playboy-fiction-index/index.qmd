...
createDataTable(
  ...
  displayed_columns = c("Unique_ID","Publication_date","Title","Section","Author_name","Last_name","First_name","Author_gender","Author_NEA","Author_bestseller","Author_prize","Author_iowa"),
  ...
  category_columns = c("Publication_date","Section","Author_name","Last_name","First_name","Author_gender","Author_NEA","Author_bestseller","Author_prize","Author_iowa"),

    # Select column to sort by, and order
  sort_columns = c("Unique_ID"),
  sort_orders = c("desc")
)
```
