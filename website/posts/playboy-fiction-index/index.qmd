...
image: "https://www.needpix.com/photo/33347/playboy-bunny-logo-club-mens-club-magazine-american-black-hugh-hefner"
...
---
 ...
 ![iStock image of Playboy logo.](https://www.needpix.com/photo/33347/playboy-bunny-logo-club-mens-club-magazine-american-black-hugh-hefner){width=70% fig-align="center"}
...
createDataTable(
  data_path = "https://raw.githubusercontent.com/Post45-Data-Collective/data/refs/heads/main/playboy_fiction_index/playboy-fiction-index-metadata_20260415.csv")

  # MAKE EDITS HERE: Select the columns that will be displayed in the data table, and the order
  displayed_columns = ("Unique_ID","Publication_date","Title","Section","Author_name","Last_name","First_name","Author_gender","Author_NEA","Author_bestseller","Author_prize","Author_iowa"),
  ...
  category_columns = ("Publication_date","Section","Author_name","Last_name","First_name","Author_gender","Author_NEA","Author_bestseller","Author_prize","Author_iowa")

    # Select column to sort by, and order
  sort_columns = ("Unique_ID"),
  sort_orders = ("desc")
)
```
...
**unique\_id**			unique identifier for each short story in the index

**publication\_date**		magazine issue date (MM-DD-YYYY); for combined   
Issue the earliest month is used (e.g., Jan/Feb 2016 is recorded as 01/01/2016; Spring 2020 is recorded as 03/01/2020)

**title**				story title; title case applied

**section**			section of the magazine in which the short story appeared, as   
listed in the magazine table of contents

**author\_name**			author name  
names were standardized resolving spelling variations and middle   
initials

**first\_name**			author first name, extracted from author\_name and including  
middle name

**last\_name**			author last name, extracted from author\_name

**gender**			author gender, recorded in binary form (m/f); co-authored entries,   
				pseudonyms, and authors for which reliable sources were not  
available were listed as N/A

**author\_NEA**	indicates whether the author received a fellowship from the National Endowment for the Arts (NEA)  
				  
**author\_bestseller**		indicates whether the author has appeared on the *New York*   
*Times* bestseller list 

**author\_prize**			indicates whether the author is the recipient of a major literary  
prize

**author\_iowa**			indicates whether the author holds an MFA from the Iowa Writers’  
Workshop
