...
```{ojs}
//| echo: false
import {generateTabulatorTableFromCSV as makeTabTable} from "8bb63a6cde9addff"
```
...
makeTabTable(
  ...
  {
    displayedColumns: ["nea_grant_year", "full_name_firstlast", "given_name_middle",
                       "family_name", "gender", "race_ethnicity", "birth_year",
                       "country", "us_state", "hometown",
                       "ba", "ba2", "ma", "ma2", "phd", "mfa", "mfa2",
                       "post45_hathi_entry", "nea_person_id"],
    columnPopups: [
      "Year the NEA Creative Writing Fellowship was awarded",
      "Full name in First-Last order",
      "Given (first) name plus middle name",
      "Family (last) name",
      "Gender as identified by the research team",
      "Race / ethnicity as identified by the research team",
      "Birth year of the fellow",
      "Country of residence",
      "US state of residence (when applicable)",
      "Hometown",
      "Institution where the fellow received a BA",
      "Second BA institution, if applicable",
      "Institution where the fellow received an MA",
      "Second MA institution, if applicable",
      "Institution where the fellow received a PhD",
      "Institution where the fellow received an MFA",
      "Second MFA institution, if applicable",
      "Whether the fellow has a corresponding entry in the Post45 HathiTrust dataset",
      "Unique numeric identifier for the fellow within this dataset"
    ],
    columnWidths: { "nea_grant_year": 130, "gender": 130, "race_ethnicity": 160,
                    "birth_year": 130, "country": 130, "us_state": 120 },
    rangeSliderColumns: ["nea_grant_year", "birth_year"],
    categoryColumns: ["gender", "race_ethnicity", "country", "us_state",
                      "ba", "ma", "phd", "mfa", "post45_hathi_entry"],
    sortColumns: ["nea_grant_year"],
    sortOrders: ["desc"],
    buttonContainerId: "#button-container-nea",
    rawButtonId: "#download-raw-nea",
    urlCopyButtonId: "#copy-url-nea",
  }
);
```

<div id="table-container-nea" style="height: 600px"></div>

Download Full Data (including hidden columns)

<div>
  <button id="download-raw-nea"><i class="fas fa-download"></i> Download Full Data</button>
  <button id="copy-url-nea"><i class="fas fa-copy"></i> Copy Full Data URL</button>
</div>

Download Table Data (filtered rows / visible columns)

<div id='button-container-nea'>
