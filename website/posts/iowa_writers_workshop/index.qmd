...
createDataTable(
    data_path = data_path,
    displayed_columns = c(
        "author1", "author1_normalized", "title", "date", "htid", "hathi_rights", "oclc_holdings", "oclc_eholdings", "place", "publisher_marc", "imprint", "isbn", "isbn_most_common_edition", "lccn", "oclc", "oclc_owi", "person_id",
