...
**Update (10/31/2025):** Please note that the authors of this dataset and essay updated both documents in October 2025. See the "Versioning" section of the data essay for additional information. The first (February 2024) version of the dataset is still accessible [here](https://github.com/Post45-Data-Collective/data/blob/main/nordic_noir_translation_database/nordic_noir_translation_database-v1.csv).
