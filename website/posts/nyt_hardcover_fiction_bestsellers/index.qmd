...
//| echo: false
//| output: false
nyt_lists_data = fetchData("https://raw.githubusercontent.com/Post45-Data-Collective/data/refs/heads/main/nyt_hardcover_fiction_bestsellers/nyt_hardcover_fiction_bestsellers-lists.csv")
```
...
<div id="table-container-nyt-lists" style="height: 600px"></div>

Download Full Data (including hidden columns)

<div>
  <button id="download-raw-nyt-lists"><i class="fas fa-download"></i> Download Full Data</button>
  <button id="copy-url-nyt-lists"><i class="fas fa-copy"></i> Copy Full Data URL</button>
</div>

Download Table Data (filtered rows / visible columns)

<div id='button-container-nyt-lists'>
...
//| echo: false
//| output: false
nyt_titles_data = fetchData("https://raw.githubusercontent.com/Post45-Data-Collective/data/refs/heads/main/nyt_hardcover_fiction_bestsellers/nyt_hardcover_fiction_bestsellers-titles.csv")
```
...
<div id="table-container-nyt-titles" style="height: 600px"></div>

Download Full Data (including hidden columns)

<div>
  <button id="download-raw-nyt-titles"><i class="fas fa-download"></i> Download Full Data</button>
  <button id="copy-url-nyt-titles"><i class="fas fa-copy"></i> Copy Full Data URL</button>
</div>

Download Table Data (filtered rows / visible columns)

<div id='button-container-nyt-titles'>
  <button id="download-csv"><i class="fas fa-download"></i> Download CSV</button>
  <button id="download-json"><i class="fas fa-download"></i> Download JSON</button>
  <button id="download-xlsx"><i class="fas fa-download"></i> Download Excel</button>
</div>
...
<div id="table-container-nyt-hathi" style="height: 600px"></div>

Download Full Data (including hidden columns)

<div>
  <button id="download-raw-nyt-hathi"><i class="fas fa-download"></i> Download Full Data</button>
  <button id="copy-url-nyt-hathi"><i class="fas fa-copy"></i> Copy Full Data URL</button>
</div>

Download Table Data (filtered rows / visible columns)

<div id='button-container-nyt-hathi'>
  <button id="download-csv"><i class="fas fa-download"></i> Download CSV</button>
  <button id="download-json"><i class="fas fa-download"></i> Download JSON</button>
  <button id="download-xlsx"><i class="fas fa-download"></i> Download Excel</button>
</div>
