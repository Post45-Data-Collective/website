...
Before you submit, please consult our two main resources for preparing data:

::: {.callout-tip appearance="default"}
## **Tabular Data Style Guide**
The [**Post45 Data Collective Tabular Data Style Guide**](style-guide.qmd) walks through how to format and document tabular humanities data for submission — from file formats and character encoding to column naming, missing values, dates, and persistent identifiers. It's the place to start if you're cleaning, structuring, or documenting a dataset for P45DC (or for any tabular humanities project).
:::

::: {.callout-tip appearance="default"}
## **BookReconciler 📘💎**
[**BookReconciler**](our-tools.qmd) is the Post45 Data Collective's free, open-source tool for adding persistent identifiers to bibliographic data. Given a spreadsheet of book titles and authors, it queries the **Library of Congress, VIAF, Wikidata, HathiTrust, OCLC,** and **Google Books** in bulk and matches your records to their canonical IDs — and it can cluster different editions of the same Work together. See the [BookReconciler page](our-tools.qmd) for setup instructions and a video walkthrough. If you can't run it yourself, we may be able to collaborate with you to add identifiers.
:::
